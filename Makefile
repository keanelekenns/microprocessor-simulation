...
DEPS = memory.h alu.h decode.h execute.h file_reader.h
OBJ = main.o memory.o ALU.o decode.o execute.o file_reader.o
SOURCES = main.c memory.c ALU.c decode.c execute.c file_reader.c
