...
OBJ = main.o ALU.o decode.o execute.o read_file.o
SOURCES = main.c ALU.c decode.c execute.c read_file.c
...
execute_test: execute_test.o ALU.o decode.o execute.o
